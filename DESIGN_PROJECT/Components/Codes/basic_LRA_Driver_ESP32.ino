...
// Define Super Mini Pins for clarity
#define I2C_SDA 6
#define I2C_SCL 7
...
void setup() {
  // Use 115200 for Super Mini USB stability
  Serial.begin(115200);
  while (!Serial) delay(10); 
  
  // FIX for Core 3.3.8: Set pins globally before starting Wire
  ...
  // Added from your working reference for LRA support
  drv.useLRA();
  drv.selectLibrary(1);
